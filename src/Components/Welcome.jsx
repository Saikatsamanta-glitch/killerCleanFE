  ...
  return (
    <div className="md:mb-5 max-xxl:w-full">
      <div className="md:flex md:items-center max-sm:p-2 sm:p-4 lg:p-[50px] home w-full">
        <div
          className=" max-sm:py-4 max-sm:px-4 flex flex-col items-center justify-center 
                         sm:p-4 sm:m-4 md:items-start sm:justify-evenly"
        >
          <h1
            className=" max-sm:text-center sm:max-md:text-center md:text-left text-[32px] mm:max-sm:text-[36px] sm:max-lg:text-[38px] text-[#014584] font-semibold
          ...
          <p
            className="text-[#014584] max-sm:mb-10 max-sm:text-center text-lg sm:text-center md:text-left
        ...
        <div className="max-sm:px-8 max-sm:py-3 sm:max-md:p-8 md:p-8 relative z-20">
