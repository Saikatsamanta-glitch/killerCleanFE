  ...
  return (
    <div className="w-screen ">
      <div className="nav-header h-[55px] bg-[#014584] flex items-center w-full px-24  justify-between ">
        ...
        <div className=" flex items-center text-[24px]">
          <Link className='no-underline text-white'><i className="fa-brands fa-facebook mr-6 hover:animate-pulse "></i></Link>
    ...
    <Navbar fluid className="px-20 bg-[#F3FAFC] sticky top-0 z-10 w-full">
      ...
      <Navbar.Collapse>
        ...
        <Navbar.Link href="/cleaningchecklist">Cleaning Checklist</Navbar.Link>
        <Navbar.Link href="/customerlogin">Customer Login</Navbar.Link>
        <Navbar.Link href="/contact">Contact</Navbar.Link>
        <Navbar.Link href="/applynow">Apply Now</Navbar.Link>
        {
          (isMobile || isTablet)? <Navbar.Link href="/book">Book Online</Navbar.Link> :<Button as={Link} to={'/book'}>Book Online</Button>
        }
      </Navbar.Collapse>
    </Navbar>
    </div>
